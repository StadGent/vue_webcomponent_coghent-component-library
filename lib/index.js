...
const _hoisted_1 = { class: "h-auto w-9/12 bg-background-dark" };
const _hoisted_2 = { class: "w-auto h-auto float-right pr-5 pt-2 bg-background-dark" };
const _hoisted_3 = { class: "bg-background-dark" };
