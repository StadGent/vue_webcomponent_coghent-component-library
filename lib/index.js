...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", null, [
    vue.withDirectives(vue.createElementVNode("div", _hoisted_1$2, _hoisted_11$1, 512 /* NEED_PATCH */), [
    ...
    vue.createElementVNode("div", {
      class: vue.normalizeClass(["p-5", { [`bg-accent-green w-3/12`]: !_ctx.large, [`bg-background-medium w-full`]: _ctx.large }])
    }, [
