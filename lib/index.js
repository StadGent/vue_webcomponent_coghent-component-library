...
var script$1 = vue.defineComponent({
    ...
    setup: function (props, _a) {
        var emit = _a.emit;
        var tagSelected = vue.ref(props.selected);
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("span", _hoisted_1$1, [
      vue.withDirectives(vue.createElementVNode("span", _hoisted_2$1, "🗸", 512 /* NEED_PATCH */), [
        [vue.vShow, _ctx.tagSelected]
      ]),
      vue.createCommentVNode(" <base-icon icon=\"storybox\" /> "),
...
exports.BaseButton = script$3;
exports.BaseIcon = script$4;
exports.BaseInput = script$2;
exports.FilterTag = script$1;
