...
export type Entity = {
  ...
  id: Scalars['String'];
  ldesResource?: Maybe<Scalars['String']>;
  linkedParentEntity?: Maybe<Entity>;
...
export type Mutation = {
  ...
  AddRelation: Array<Maybe<Relation>>;
  AddStoryToBoxVisiter?: Maybe<BoxVisiter>;
  AddTouchTableTime?: Maybe<BoxVisiter>;
  CreateTestimony?: Maybe<Array<Maybe<Entity>>>;
...
export type QueryCheckIfUploadIsDuplicateArgs = {
...
export type QueryCreateSubtitlesForUploadArgs = {
  frameId: Scalars['String'];
};
...
export type QueryGetTestimoniesOfAssetArgs = {
  assetId: Scalars['String'];
};
...
export type QueryLinkTestimonyToAssetArgs = {
  assetId: Scalars['String'];
...
export type QueryPublishStoryboxArgs = {
  frameId: Scalars['String'];
};
...
export enum RelationType {
  ...
  Stories = 'stories',
  StoryBox = 'story_box',
  StoryBoxVisits = 'story_box_visits',
...
export type StoryboxBuild = {
  ...
  assetDescriptions?: Maybe<Array<Maybe<KeyValuePair>>>;
...
export type StoryboxBuildInput = {
  assetDescriptions?: Maybe<Array<Maybe<KeyValuePairInput>>>;
...
export type TestimonyFragment = { __typename?: 'Entity', id: string, user?: Maybe<string>, description: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value?: Maybe<string> }>>, likes: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value?: Maybe<string> }>>, date: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value?: Maybe<string> }>>, publicationStatus: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value?: Maybe<string> }>>, relations?: Maybe<Array<Maybe<{ __typename?: 'Relation', key: string, type: RelationType, label?: Maybe<string>, value?: Maybe<string> }>>>, linkedParentEntity?: Maybe<(
    { __typename?: 'Entity' }
...
export type AssetMetadataFragment = { __typename?: 'Relation', key: string, label?: Maybe<string>, timestamp_start?: Maybe<number>, timestamp_end?: Maybe<number>, timestamp_zoom?: Maybe<number>, scale?: Maybe<number>, audioFile?: Maybe<string>, subtitleFile?: Maybe<string>, setMediafile?: Maybe<number>, position?: Maybe<{ __typename?: 'Position', x?: Maybe<number>, y?: Maybe<number>, z?: Maybe<number> }> };

export type FullMediafileFragment = { __typename?: 'MediaFile', _id: string, original_file_location?: Maybe<string>, filename?: Maybe<string>, transcode_filename?: Maybe<string>, thumbnail_file_location?: Maybe<string>, transcode_file_location?: Maybe<string>, mimetype?: Maybe<string>, mediatype?: Maybe<{ __typename?: 'MimeType', type?: Maybe<string>, mime?: Maybe<Mime>, image?: Maybe<boolean>, audio?: Maybe<boolean>, video?: Maybe<boolean>, pdf?: Maybe<boolean> }>, metadata?: Maybe<Array<Maybe<{ __typename?: 'MediaFileMetadata', key?: Maybe<string>, value?: Maybe<string> }>>> };

export type FullUploadComposableFragment = { __typename?: 'UploadComposable', file_location?: Maybe<string>, base64Image?: Maybe<string>, liscense?: Maybe<string>, metadata?: Maybe<Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value?: Maybe<string> }>>>, relations?: Maybe<Array<Maybe<{ __typename?: 'Relation', key: string, type: RelationType, value?: Maybe<string> }>>> };
...
export type CheckIfUploadIsDuplicateQueryVariables = Exact<{
  base64Image: Scalars['String'];
}>;


export type CheckIfUploadIsDuplicateQuery = { __typename?: 'Query', CheckIfUploadIsDuplicate: { __typename?: 'StringResult', result: string } };

export type CreateSubtitlesForUploadQueryVariables = Exact<{
  frameId: Scalars['String'];
}>;


export type CreateSubtitlesForUploadQuery = { __typename?: 'Query', CreateSubtitlesForUpload: { __typename?: 'StringResult', result: string } };
...
export type CreateTestimonyMutation = { __typename?: 'Mutation', CreateTestimony?: Maybe<Array<Maybe<(
    { __typename?: 'Entity' }
    & TestimonyFragment
  )>>> };

export type LinkTestimonyToAssetQueryVariables = Exact<{
  assetId: Scalars['String'];
  testimonyId: Scalars['String'];
}>;


export type LinkTestimonyToAssetQuery = { __typename?: 'Query', LinkTestimonyToAsset?: Maybe<Array<Maybe<{ __typename?: 'Relation', key: string, type: RelationType, label?: Maybe<string>, value?: Maybe<string> }>>> };

export type GetTestimoniesOfUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTestimoniesOfUserQuery = { __typename?: 'Query', GetTestimoniesOfUser?: Maybe<Array<Maybe<(
    { __typename?: 'Entity' }
    & TestimonyFragment
  )>>> };

export type GetTestimoniesOfAssetQueryVariables = Exact<{
  assetId: Scalars['String'];
}>;


export type GetTestimoniesOfAssetQuery = { __typename?: 'Query', GetTestimoniesOfAsset?: Maybe<Array<Maybe<(
    { __typename?: 'Entity' }
    & TestimonyFragment
  )>>> };
...
export type AddRelationMutation = { __typename?: 'Mutation', AddRelation: Array<Maybe<(
    { __typename?: 'Relation' }
    & BoxRelationFragment
  )>> };
...
export type PublishStoryboxQueryVariables = Exact<{
  frameId: Scalars['String'];
}>;


export type PublishStoryboxQuery = { __typename?: 'Query', PublishStorybox: { __typename?: 'BoxVisiter', id: string, code: string } };
...
export const TestimonyFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"testimony"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Entity"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","alias":{"kind":"Name","value":"description"},"name":{"kind":"Name","value":"metadata"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"description"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"likes"},"name":{"kind":"Name","value":"metadata"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"likes"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"date"},"name":{"kind":"Name","value":"metadata"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"date"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"publicationStatus"},"name":{"kind":"Name","value":"metadata"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"publication_status"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"relations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"linkedParentEntity"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"minimalEntity"}}]}},{"kind":"Field","name":{"kind":"Name","value":"user"}}]}}]} as unknown as DocumentNode<TestimonyFragment, unknown>;
...
export const CheckIfUploadIsDuplicateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"checkIfUploadIsDuplicate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"base64Image"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"CheckIfUploadIsDuplicate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"base64Image"},"value":{"kind":"Variable","name":{"kind":"Name","value":"base64Image"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"}}]}}]}}]} as unknown as DocumentNode<CheckIfUploadIsDuplicateQuery, CheckIfUploadIsDuplicateQueryVariables>;
export const CreateSubtitlesForUploadDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"createSubtitlesForUpload"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"frameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"CreateSubtitlesForUpload"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"frameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"frameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"}}]}}]}}]} as unknown as DocumentNode<CreateSubtitlesForUploadQuery, CreateSubtitlesForUploadQueryVariables>;
...
export const CreateTestimonyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateTestimony"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"entityInfo"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EntityInfo"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"CreateTestimony"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"entityInfo"},"value":{"kind":"Variable","name":{"kind":"Name","value":"entityInfo"}}},{"kind":"Argument","name":{"kind":"Name","value":"assetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"testimony"}}]}}]}},...TestimonyFragmentDoc.definitions,...MinimalEntityFragmentDoc.definitions]} as unknown as DocumentNode<CreateTestimonyMutation, CreateTestimonyMutationVariables>;
export const LinkTestimonyToAssetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LinkTestimonyToAsset"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"testimonyId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"LinkTestimonyToAsset"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"assetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}}},{"kind":"Argument","name":{"kind":"Name","value":"testimonyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"testimonyId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]} as unknown as DocumentNode<LinkTestimonyToAssetQuery, LinkTestimonyToAssetQueryVariables>;
export const GetTestimoniesOfUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTestimoniesOfUser"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"GetTestimoniesOfUser"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"testimony"}}]}}]}},...TestimonyFragmentDoc.definitions,...MinimalEntityFragmentDoc.definitions]} as unknown as DocumentNode<GetTestimoniesOfUserQuery, GetTestimoniesOfUserQueryVariables>;
export const GetTestimoniesOfAssetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTestimoniesOfAsset"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"GetTestimoniesOfAsset"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"assetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"testimony"}}]}}]}},...TestimonyFragmentDoc.definitions,...MinimalEntityFragmentDoc.definitions]} as unknown as DocumentNode<GetTestimoniesOfAssetQuery, GetTestimoniesOfAssetQueryVariables>;
...
export const AddRelationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"addRelation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"entityId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"relation"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RelationInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"collection"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"AddRelation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"entityId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"entityId"}}},{"kind":"Argument","name":{"kind":"Name","value":"relation"},"value":{"kind":"Variable","name":{"kind":"Name","value":"relation"}}},{"kind":"Argument","name":{"kind":"Name","value":"collection"},"value":{"kind":"Variable","name":{"kind":"Name","value":"collection"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"boxRelation"}}]}}]}},...BoxRelationFragmentDoc.definitions]} as unknown as DocumentNode<AddRelationMutation, AddRelationMutationVariables>;
export const UpdateEntityDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updateEntity"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"metadata"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MetadataInput"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"relations"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RelationInput"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"UpdateEntity"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"metadata"},"value":{"kind":"Variable","name":{"kind":"Name","value":"metadata"}}},{"kind":"Argument","name":{"kind":"Name","value":"relations"},"value":{"kind":"Variable","name":{"kind":"Name","value":"relations"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"object_id"}},{"kind":"Field","name":{"kind":"Name","value":"metadata"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"ListValue","values":[{"kind":"EnumValue","value":"title"},{"kind":"EnumValue","value":"description"},{"kind":"EnumValue","value":"object_number"},{"kind":"EnumValue","value":"publication_status"},{"kind":"EnumValue","value":"user_action"}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"label"}}]}},{"kind":"Field","name":{"kind":"Name","value":"relations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateEntityMutation, UpdateEntityMutationVariables>;
export const PublishStoryboxDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"publishStorybox"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"frameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"PublishStorybox"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"frameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"frameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}}]}}]}}]} as unknown as DocumentNode<PublishStoryboxQuery, PublishStoryboxQueryVariables>;