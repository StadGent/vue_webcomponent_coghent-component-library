...
export type BoxRelationFragment = { __typename?: 'Relation', key: string, type: RelationType, active?: Maybe<boolean>, order?: Maybe<number>, last_frame?: Maybe<string>, seen_frames?: Maybe<Array<Maybe<{ __typename?: 'FrameSeen', id: string, date: number }>>> };
