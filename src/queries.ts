...
export type GetStoriesQuery = { __typename?: 'Query', Entities?: Maybe<{ __typename?: 'EntitiesResults', count?: Maybe<number>, limit?: Maybe<number>, results?: Maybe<Array<Maybe<(
      { __typename?: 'Entity', frames?: Maybe<Array<Maybe<(
        { __typename?: 'Entity', relationMetadata?: Maybe<Array<Maybe<{ __typename?: 'Relation', key: string, label?: Maybe<string>, timestamp_start?: Maybe<number>, timestamp_end?: Maybe<number> }>>>, assets?: Maybe<Array<Maybe<{ __typename?: 'Entity', id: string, title: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value: string }>>, collections: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value: string }>>, dimensions: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value: string }>>, timestamps: Array<Maybe<{ __typename?: 'Metadata', key: MetaKey, value: string }>>, mediafiles?: Maybe<Array<Maybe<{ __typename?: 'MediaFile', original_file_location?: Maybe<string> }>>> }>>> }
        & StoryEntityFragment
      )>>> }
      & StoryEntityFragment
    )>>> }> };
