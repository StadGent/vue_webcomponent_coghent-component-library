...
export type MinimalEntityFragment = {
  __typename?: "Entity"
  id: string
  type: string
  metadata: Array<
    Maybe<{ __typename?: "Metadata"; key: MetaKey; value: string }>
  >
}
...
export type FullEntityFragment = {
  ...
  id: string
  type: string
  title: Array<Maybe<{ __typename?: "Metadata"; value: string }>>
  metadata: Array<
    Maybe<{ __typename?: "Metadata"; key: MetaKey; value: string }>
  >
  mediafiles?: Maybe<
  ...
  >
  relations?: Maybe<
    Array<Maybe<{ __typename?: "Relation"; key: string; type: RelationType }>>
  >
}
...
export type GetFullEntitiesQuery = {
  __typename?: "Query"
  Entities?: Maybe<{
    __typename?: "EntitiesResults"
    count?: Maybe<number>
...
} as unknown as DocumentNode<MinimalEntityFragment, unknown>
...
>
export const GetEntityByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<GetEntityByIdQuery, GetEntityByIdQueryVariables>
