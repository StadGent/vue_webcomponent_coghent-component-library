...
export type GetActiveBoxQuery = { __typename?: 'Query', ActiveBox: Array<Maybe<{ __typename?: 'Relation', key: string, type: RelationType, label?: Maybe<string>, value?: Maybe<string>, active?: Maybe<boolean> }>> };
