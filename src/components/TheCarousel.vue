<template>
  ...
  <div class="flex items-center">
    ...
    <div class="flex flex-col items-center w-3/4 relative">
      ...
      <copyright-tab class="absolute top-0 right-0 w-full h-full" :infotext="infotext" @openingCcmodal="openCCModal"/>
...
export default defineComponent({
  ...
  components: { BaseButton, BaseModal, IIIFViewer, BaseIcon, CopyrightTab },
