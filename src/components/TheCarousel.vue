<template>
  ...
  <base-modal :showHeader="false" v-model:isShow="openModal" class="z-50">
    <section class="h-large flex relative w-full"><IIIFViewer :imageUrl="source[selectedIndex]" /></section>
  </base-modal>
  <!--Carousel -->
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { selectedIndex, prevImage, nextImage, getNextImage, getPrevImage, openFullscreenModal, openModal }
  },
})
</script>
<style scoped></style>
