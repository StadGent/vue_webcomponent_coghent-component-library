<template>
  <div class="flex items-center">
    <div class="h-96 w-72 z-0 mr-5 mt-24"><img class="h-96 w-72 opacity-70" :src="source[getPrevImage()]" v-show="source.length > 2" /></div>
    <div class="flex flex-col items-center">
      <img class="w-72 h-96 z-10" :src="source[selectedIndex]" />
    ...
    <div class="w-72 h-96 z-0 ml-5 mt-24"><img class="w-72 h-96 opacity-70" :src="source[getNextImage()]" v-show="source.length > 1" /></div>
  </div>
</template>
<script lang="ts">
