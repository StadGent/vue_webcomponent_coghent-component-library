<template>
  ...
  <div v-else>
    <div
      class="tag flex items-center text-xl font-semibold cursor-pointer"
      :class="style"
    >
      <base-icon
        v-show="isSelected"
...
const styles: Record<TagStyle, string> = {
  ...
  bigPrimary: "bg-tag-neutral text-text-dark p-4 mx-2 my-2 text-center",
  bigSelected: "bg-tag-selected text-text-white p-4 mx-2 my-2 text-center",
  bigLoading:
    "bg-tag-neutral text-text-dark p-4 mx-2 my-2 text-center animate-pulse",
};
