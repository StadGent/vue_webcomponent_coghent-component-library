<template>
  <div>
    <div class="bg-background-medium w-6/12 h-auto" v-show="large">
      <div class="h-14 items-center flex overflow-hidden">
        ...
        <div class="bg-text-white rounded-full w-9 h-4 flex-shrink-0 shadow-inner 2xl:ml-4 ml-4"></div>
        <div class="bg-text-white rounded-full w-4 h-4 flex-shrink-0 shadow-inner 2xl:ml-4 ml-4"></div>
        <div class="bg-text-white rounded-full w-9 h-4 flex-shrink-0 shadow-inner 2xl:ml-24 xl:ml-16 ml-24"></div>
      </div>
    </div>
    ...
    <div class="p-5" :class="{ [`bg-accent-green w-3/12`]: !large, [`bg-background-medium w-6/12`]: large }">
      <slot></slot>
    </div>
  </div>
</template>
